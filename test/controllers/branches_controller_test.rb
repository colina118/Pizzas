...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { adress: @branch.adress, phone_number: @branch.phone_number, postal_code: @branch.postal_code }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { adress: @branch.adress, phone_number: @branch.phone_number, postal_code: @branch.postal_code }
    assert_redirected_to branch_path(assigns(:branch))
  end
